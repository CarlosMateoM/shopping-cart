...
<template>
    ...
    <Head title="Tus animes favoritos" />

    <NavBar class="sticky top-0 z-50" canLogin="{{ canLogin }}" :navbarStyle="navbarStyle" />

    <!--
    <div class="w-full ">

        <p class="text-8xl  tracking-tight leading-none text-center font-black  mt-44">
            Un espacio donde encontras <br> todos tus mangas a los <br> mejores precios
        </p>

        <div class="background-img mb-24 mt-24">
            <div class="circle">
                <img class="h-auto max-w-lg mx-auto" :src="'/img/cover/' + mangas[0].image_path" alt="error">
    ...
    <div class="flex flex-wrap justify-center mt-12">
        <div class="flex flex-wrap w-11/12 justify-around gap-y-7">

            <div v-for="manga in mangas" class="w-72 rounded-lg shadow-md" style="background-color: antiquewhite">
                <a href="#">
                    <img class="object-cover h-80 w-72 rounded-t-lg" :src="'/img/cover/' + manga.image_path"
                        alt="product image" />
                </a>
                <div class="px-5 pb-5">
                    <a href="#">
                        <h5 class="mt-4 text-xl font-semibold tracking-tight text-gray-900 ">{{ manga.title }}</h5>
                    </a>
                    {{ manga.author.person.first_name + ' ' + manga.author.person.frist_surname }}
                    <br>
                    ...
                    <div class="flex items-center justify-between">
                        <span class="text-3xl font-bold text-gray-600">{{ formatMoney(manga.price) }}</span>
                        <a href="#"
                            class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center "
                            style="background-color:rgb(20, 19, 19)">Agregar</a>
                    </div>
                </div>
            </div>
